...
private static        tfm.PMDG.PMDG_747.McpComponents.AltitudeBox AltitudeBox = new PMDG.PMDG_747.McpComponents.AltitudeBox();
        ...
        private static Dictionary<byte, string> _IRSSelectorStates = new Dictionary<byte, string>()
        {
            {0, "off" },
            {1, "align" },
            {2, "nav" },
...
// --panel: overhead
// ---panel: IRS
new SingleStateToggle { Name = "Left IRS", PanelName = "Overhead", PanelSection = "IRS", Type = PanelObjectType.Switch, Verbosity = AircraftVerbosity.Low, Offset = Aircraft.pmdg747.IRS_Selector[0], AvailableStates = _offOrOnStates, shouldSpeak = Properties.pmdg747_offsets.Default.IRS_Selector_Left},
new SingleStateToggle { Name = "Center IRS", PanelName = "Overhead", PanelSection = "IRS", Type = PanelObjectType.Switch, Verbosity = AircraftVerbosity.Low, Offset = Aircraft.pmdg747.IRS_Selector[1], AvailableStates = _offOrOnStates, shouldSpeak = Properties.pmdg747_offsets.Default.IRS_Selector_Center},
new SingleStateToggle { Name = "Right IRS", PanelName = "Overhead", PanelSection = "IRS", Type = PanelObjectType.Switch, Verbosity = AircraftVerbosity.Low, Offset = Aircraft.pmdg747.IRS_Selector[2], AvailableStates = _offOrOnStates, shouldSpeak = Properties.pmdg747_offsets.Default.IRS_Selector_Right},
new SingleStateToggle { Name="IRS on battery light", PanelName = "Overhead", PanelSection = "IRS", Type = PanelObjectType.Annunciator, Verbosity = AircraftVerbosity.Low, Offset = Aircraft.pmdg747.IRS_annunON_BAT, AvailableStates = _onOrOffStates, shouldSpeak = Properties.pmdg747_offsets.Default.IRS_annunON_BAT},
// --panel: electrical
new SingleStateToggle { Name = "utility 1 off light", PanelName = "Overhead", PanelSection = "Electrical", Type = PanelObjectType.Annunciator, Verbosity = AircraftVerbosity.Low, Offset = Aircraft.pmdg747.ELEC_annunUtilOFF[0], AvailableStates = _onOrOffStates, shouldSpeak = Properties.pmdg747_offsets.Default.ELEC_annunUtilOFF},
new SingleStateToggle { Name = "utility 2 off light", PanelName = "Overhead", PanelSection = "Electrical", Type = PanelObjectType.Annunciator, Verbosity = AircraftVerbosity.Low, Offset = Aircraft.pmdg747.ELEC_annunUtilOFF[1], AvailableStates = _onOrOffStates, shouldSpeak = Properties.pmdg747_offsets.Default.ELEC_annunUtilOFF},
new SingleStateToggle { Name = "Battery switch", PanelName = "Overhead", PanelSection = "Electrical", Type = PanelObjectType.Switch, Verbosity = AircraftVerbosity.Low, Offset = Aircraft.pmdg747.ELEC_Battery_Sw_ON, AvailableStates = _onOrOffStates, shouldSpeak = Properties.pmdg747_offsets.Default.ELEC_Battery_Sw_ON},
