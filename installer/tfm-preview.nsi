...
Name "Talking Flight Monitor preview"
Caption "Talking Flight Monitor preview ${VERSION} Setup"

OutFile "${OUTFILE}"
InstallDir "$PROGRAMFILES\talking flight monitor preview"
InstallDirRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\talking-flight-monitor-preview" "InstallLocation"
RequestExecutionLevel admin
SetCompress auto
SetCompressor /solid lzma
SetDatablockOptimize on
VIProductVersion "24.1.7.0" ;Needs to be here so other version info shows up
VIAddVersionKey "ProductName" "Talking Flight Monitor preview"
VIAddVersionKey "LegalCopyright" "${COPYRIGHT}"
VIAddVersionKey "FileDescription" "Talking Flight Monitor preview installer"
...
CreateShortCut "$DESKTOP\Talking Flight Monitor Preview.lnk" "$INSTDIR\tfm.exe"
...
WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\tfm" "DisplayName" "Talking Flight Monitor preview"
